...
public extension Stylable where Self: UIViewController {
    ...
    func transition<T: UIViewController>(storyboard: String, viewController: T.Type, style: TransitionStyle, animated: Bool = true, preprocessViewController: ((_ vc: T) -> ())? = nil) {
    ...
    ///   - style: Transition Style
    func transition<T: UIViewController>(viewController vc: T, style: TransitionStyle, animated: Bool = true, preprocessViewController: ((_ vc: T) -> ())? = nil) {
